...
#  end
  ...
  # This is a usage of suer/omniauth-redmine

  config.omniauth :redmine, "{{OAUTH_REDMINE_API_KEY}}", "{{OAUTH_REDMINE_APP_SECRET}}", :redmine_base_url => "{{OAUTH_REDMINE_BASE_URL}}"
end
